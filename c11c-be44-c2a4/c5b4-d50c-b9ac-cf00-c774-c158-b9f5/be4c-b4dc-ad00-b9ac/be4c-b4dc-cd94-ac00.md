...
**a\) 서비스 **→** 빌드 관리 → 빌드추가 선택하여 해당 페이지로 이동**![](/assets/KR/3.0.0/3.2.1_1.png)![](/assets/KR/3.0.0/3.2.1_2.png)

**b\) 어플리케이션 다운로드, 어플리케이션 빌드, 이미지 빌드 내용을 작성하고 생성버튼을 눌러 서버를 생성**![](/assets/KR/3.0.0/3.2.1_3.png)
...
* **빌드** **기본 정보**![](/assets/2.3.0 빌드 추가3.png)
...
* **어플리케이션 다운로드**![](/assets/2.3.0 빌드 추가4.png)
...
* **어플리케이션 빌드**![](/assets/2.3.0 빌드 추가5.png)
...
* **이미지 빌드**![](/assets/2.3.0 빌드 추가6.png)
