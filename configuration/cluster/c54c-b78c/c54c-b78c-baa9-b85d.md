...
| 조치 사항 | ETCD 메트힉 문서\(https://github.com/coreos/etcd/blob/master/Documentation/metrics.md\)에 따르면 디스크 문제시 발생한다고 함. Kubernetes 마스터 노드와 같이 실행중이라면 ETCD 클러스터의 분리도 고려. |
