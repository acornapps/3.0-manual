...
청지원은 `올인원 컨테이너 관리 플랫폼(All-in-one Container Management Platform)`이다.
...
청지원은 컨테이너의 장점을 클라우드 관리에 적용하여, 개발 및 운영 업무를 효율화 하고 단일 또는 멀티/하이브리드 클라우드 전략 구현을 위한 플랫폼을 제공한다.
...
다음글 : [청지원 구성 개요](/cocktail-cloud-ad6c-c131-ac1c-c694.md)
